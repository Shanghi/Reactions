...
function RSGUI.reactions.new(main)
	...
	conditionsButtonMenu.GroupAll =
		{notCheckable=1, notClickable=1, hasArrow=1, text="|cffffffffGroup Member|r", menuList={
			...
			{notCheckable=1, notClickable=1, text=""},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_GROUP_MEMBER, checked=function() return self:IsConditionsItemChecked("GroupFocus")     end, value="GroupFocus",      text="|cffffffffGroup member is on /focus|r"},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_GROUP_MEMBER, checked=function() return self:IsConditionsItemChecked("GroupNotFocus")  end, value="GroupNotFocus",   text="|cffffffffGroup member is not on /focus|r"},
			{notCheckable=1, notClickable=1, text=""},
	...
	conditionsButtonMenu.CasterAll =
		{notCheckable=1, notClickable=1, hasArrow=1, text="|cffffffffCaster (All)|r", menuList={
			...
			{notCheckable=1, notClickable=1, text=""},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_CASTER, checked=function() return self:IsConditionsItemChecked("CasterFocus")      end, value="CasterFocus",      text="|cffffffffCaster is on /focus|r"},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_CASTER, checked=function() return self:IsConditionsItemChecked("CasterNotFocus")   end, value="CasterNotFocus",   text="|cffffffffCaster is not on /focus|r"},
			{notCheckable=1, notClickable=1, text=""},
			...
			{notCheckable=1, notClickable=1, text=""},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_CASTER, checked=function() return self:IsConditionsItemChecked("CasterFriendlyReaction") end, value="CasterFriendlyReaction", text="|cffffffffCaster is friendly|r"},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_CASTER, checked=function() return self:IsConditionsItemChecked("CasterNeutralReaction")  end, value="CasterNeutralReaction",  text="|cffffffffCaster is neutral|r"},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_CASTER, checked=function() return self:IsConditionsItemChecked("CasterHostileReaction")  end, value="CasterHostileReaction",  text="|cffffffffCaster is hostile|r"},
			{notCheckable=1, notClickable=1, text=""},
	...
	conditionsButtonMenu.TargetAll =
		{notCheckable=1, notClickable=1, hasArrow=1, text="|cffffffffTarget (All)|r", menuList={
			...
			{notCheckable=1, notClickable=1, text=""},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_TARGET, checked=function() return self:IsConditionsItemChecked("TargetFocus")     end, value="TargetFocus",      text="|cffffffffTarget is on /focus|r"},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_TARGET, checked=function() return self:IsConditionsItemChecked("TargetNotFocus")  end, value="TargetNotFocus",   text="|cffffffffTarget is not on /focus|r"},
			{notCheckable=1, notClickable=1, text=""},
			...
			{notCheckable=1, notClickable=1, text=""},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_TARGET, checked=function() return self:IsConditionsItemChecked("TargetFriendlyReaction") end, value="TargetFriendlyReaction", text="|cffffffffTarget is friendly|r"},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_TARGET, checked=function() return self:IsConditionsItemChecked("TargetNeutralReaction")  end, value="TargetNeutralReaction",  text="|cffffffffTarget is neutral|r"},
			{keepShownOnClick=1, func=SetConditionsFromMenu, arg1=CONDITION_TYPE_TARGET, checked=function() return self:IsConditionsItemChecked("TargetHostileReaction")  end, value="TargetHostileReaction",  text="|cffffffffTarget is hostile|r"},
			{notCheckable=1, notClickable=1, text=""},
